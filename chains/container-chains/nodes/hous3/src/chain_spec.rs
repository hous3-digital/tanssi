...
use {
    container_chain_template_hous3_runtime::{
...
pub fn development_config(para_id: ParaId, boot_nodes: Vec<String>) -> ChainSpec {
    ...
    ChainSpec::builder(
        container_chain_template_hous3_runtime::WASM_BINARY
...
fn testnet_genesis(
    ...
    let g = container_chain_template_hous3_runtime::RuntimeGenesisConfig {
        system: Default::default(),
        balances: container_chain_template_hous3_runtime::BalancesConfig {
        ...
        parachain_info: container_chain_template_hous3_runtime::ParachainInfoConfig {
            parachain_id: id,
            ..Default::default()
        },
        ...
        sudo: container_chain_template_hous3_runtime::SudoConfig {
            key: Some(root_key),
        },
        authorities_noting: container_chain_template_hous3_runtime::AuthoritiesNotingConfig {
