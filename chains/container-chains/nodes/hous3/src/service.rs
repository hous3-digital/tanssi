...
#[allow(deprecated)]
use {
    container_chain_template_hous3_runtime::{opaque::Block, RuntimeApi},
...
impl sp_inherents::InherentDataProvider for MockTimestampInherentDataProvider {
    async fn provide_inherent_data(
        ...
        TIMESTAMP.with(|x| {
            *x.borrow_mut() += container_chain_template_hous3_runtime::SLOT_DURATION;
    ...
    if parachain_config.role.is_authority() {
        ...
        command_sink = node_builder.install_manual_seal(ManualSealConfiguration {
            ...
            consensus_data_provider: Some(Box::new(
                tc_consensus::ContainerManualSealAuraConsensusDataProvider::new(
                    SlotDuration::from_millis(
                        container_chain_template_hous3_runtime::SLOT_DURATION,
                    ),
                    authorities.clone(),
                ),
            )),
            create_inherent_data_providers: move |block: H256, ()| {
                ...
                let slot_duration = container_chain_template_hous3_runtime::SLOT_DURATION;
