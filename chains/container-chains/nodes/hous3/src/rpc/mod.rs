...
use {
    container_chain_template_hous3_runtime::{opaque::Block, AccountId, Hash, Index, RuntimeApi},
    ...
    P: TransactionPool<Block = Block> + 'static,
{
    ...
    > = Some(Box::new(
        tc_consensus::ContainerManualSealAuraConsensusDataProvider::new(
            SlotDuration::from_millis(container_chain_template_hous3_runtime::SLOT_DURATION),
            authorities_for_cdp,
        ),
    ));
